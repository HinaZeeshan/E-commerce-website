...
//               Explore Our section Of Mouth Watering Cakes Flavour to Order Now!
//             </p>
//           </div>
//           {/* products section */}
//           <div className="max-w-6xl mx-auto p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-pink-800 ">
...
//             <button
//               onClick={togglecart}
//               className="bg-pink-800 text-white px-6 rounded-lg shadow-md hover:bg-pink-900 transition duration-300 ease-out transform "
//             >
//               {showcart ? "Hide cart" : "view cart"} ({cart.length} items)
//             </button>
//             {showcart && (
...
//                         <button
//                           onClick={goTocheckout}
//                           className="bg-violet-800 py-3 px-8 rounded-lg text-lg shadow-lg  hover:bg-violet-600 transition duration-300 ease-in-out text-white  transform scale-105"
//                         >
//                           Proceed To CheckOut
//                         </button>
